		...
		<div class="admin-content">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">入库管理</strong> / <small>入库明细</small>
				</div>
			</div>
				...
				<div class="am-tabs am-margin" data-am-tabs>
					...
					<div class="am-tabs-bd">
						...
						<div class="am-g am-margin-top-sm">
							...
							<div class="am-u-sm-4 am-u-end">
								<select name="pbid">
									...
									<option ${back.provider.pbid==p.pbid ? ' selected="selected"' : ''} value="${p.pbid}">${p.pbid}</option>
									</c:forEach>
								</select>
							</div>
						</div>
						...
						<div class="am-g am-margin-top-sm">
							...
							<div class="am-u-sm-4 am-u-end">
								<input type="text" name="pbdid" class="am-input-sm" value="${back.pbdid }">
							</div>
						</div>
						<div class="am-g am-margin-top-sm">
