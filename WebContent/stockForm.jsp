		...
		<div class="admin-content">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">入库管理</strong> / <small>采购订单</small>
				</div>
			</div>

			<form class="am-form" method="post" action="StockModify">
				<input type="hidden" name="act" value="${empty requestScope.stock ? 'add' : 'mdy'}">
				<input type="hidden" name="s" value="${requestScope.stock.sid}">
				<div class="am-tabs am-margin" data-am-tabs>
					<ul class="am-tabs-nav am-nav am-nav-tabs">
						<li class="am-active"><a href="#tab1">${empty requestScope.stock ? '新增' : '修改' }采购信息</a></li>
					</ul>
					<div class="am-tabs-bd">
						...
						<div class="am-g am-margin-top-sm">
							...
							<div class="am-u-sm-4 am-u-end">
								<select name="cid">
									...
									<option ${stock.custom.cid==p.cid ? ' selected="selected"' : ''} value="${p.cid}">${p.name}</option>
									</c:forEach>
								</select>
							</div>
						</div>
						<div class="am-g am-margin-top-sm">
							...
							<div class="am-u-sm-4 am-u-end">
								<input type="text" name="sid" class="am-input-sm" value="${stock.sid }">
							</div>
						</div>
						<div class="am-g am-margin-top-sm">
