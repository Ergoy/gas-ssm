		...
		<div class="admin-content">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">出库管理</strong> / <small>销售明细</small>
				</div>
			</div>

			<form class="am-form" method="post" action="SellDetailModify">
				<input type="hidden" name="act" value="${empty detail ? 'add' : 'mdy'}">
				<input type="hidden" name="s" value="${requestScope.detail.sdid}">
				<div class="am-tabs am-margin" data-am-tabs>
					<ul class="am-tabs-nav am-nav am-nav-tabs">
						<li class="am-active"><a href="#tab1">${empty detail ? '新增' : '修改' }明细信息</a></li>
					</ul>
					<div class="am-tabs-bd">
						...
						<div class="am-g am-margin-top-sm">
							...
							<div class="am-u-sm-4 am-u-end">
								<select name="sid">
									<c:forEach items="${sell}" var="p">
									<option ${detail.sell.sid==p.sid ? ' selected="selected"' : ''}value="${p.sid}">${p.sid}</option>
									</c:forEach>
								</select>
							</div>
						</div>
						...
						<div class="am-g am-margin-top-sm">
							...
							<div class="am-u-sm-4 am-u-end">
								<input type="text" name="price" class="am-input-sm" value="${detail.price }">
							</div>
						</div>
						</div>
					</div>
