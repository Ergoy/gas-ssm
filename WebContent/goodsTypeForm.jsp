...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <form class="am-form" method="post" action="GoodsTypeModify">
    <input type="hidden" name="act" value="${not empty type ? 'mdy' : 'add'}">
	<div class="am-tabs am-margin" data-am-tabs>
	    <ul class="am-tabs-nav am-nav am-nav-tabs">
	      <li class="am-active"><a href="#tab1">${empty type ? '新增' : '修改' }商品信息</a></li>
	    </ul>
